    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="bg-card rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        <div className="text-center mt-6">
          ...
          <p className="text-muted-foreground mt-1">Join Jacksonville's community platform</p>
        </div>
            ...
            {password.length > 0 && (
              <div className="mt-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {passwordStrength > 0 ? strengthLabels[passwordStrength - 1] : 'Too short'} · At least 8 characters
                </p>
              </div>
            )}
          </div>
        ...
        <p className="text-center mt-6 text-sm text-muted-foreground">
          ...
          <Link to={`/auth/signin${redirectTo !== '/' ? `?redirect=${redirectTo}` : ''}`} className="text-accent hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
